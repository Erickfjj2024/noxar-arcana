...
def run_ffmpeg(cmd: list[str], desc: str = "") -> bool:
    """Executa comando FFmpeg e loga resultado."""
...
def processar_segmento(
    ...
    """
    Processa um único segmento visual:
    1. Ken Burns na imagem
    2. Color grading por emoção
    3. Legenda karaoke (se palavras fornecidas)
    """
    # Constrói filtros
